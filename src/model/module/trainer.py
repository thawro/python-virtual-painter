...
class Trainer:
    ...
    def evaluate(
        self, dataloader, desc: str, update_metrics: bool = False, single_batch: bool = True
    ):
    ...
    def val_epoch(self):
        ...
        self.evaluate(
            self.datamodule.val_dataloader(), desc="Val", update_metrics=True, single_batch=False
        )
